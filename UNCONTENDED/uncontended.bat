...
zcc +zx -vn -clib=sdcc_iy -c -o uncontended.o -m -pragma-include:zpragma.inc @ramMain.lst

@rem original compiling string
@rem zcc +zx -vn -clib=sdcc_iy -c -o uncontended.o -m @ramMain.lst
